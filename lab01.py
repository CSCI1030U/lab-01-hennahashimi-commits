def main():
    ...
    #Error: TypeError
    #TypeError is an error that occurs when a string and float are concenated 
    #together without first converting the float to string
    #In this case the error was in line 29 in that str()  should have been
    # used to convert invesment  to a string before conatentation 
